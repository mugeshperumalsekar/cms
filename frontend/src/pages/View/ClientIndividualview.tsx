...
import { createDetailsRequest, Regulator, RegulatorListData, RecordTypeData, Dead, InorgPayload, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, CreateCaseDetailsRequest, createBankDetailsRequests, createCompanyDetailsRequests, createIndPositionsRequests, createIndCaseDetailsRequests, bank, ContactDetailsData, RelativeConfigData, CompanyPayload, CreateorganizationDetailsRequest } from '../../data/services/Search/search-payload';
...
const ClientIndividualview: React.FC = () => {
    ...
    const backendColumns = ['Profile', 'RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'Gender', 'Date of Birth', 'BirthYearAlone', 'Place of Birth', 'Dead', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Organization Details', 'Positions Detail', 'Case Detail', "Bank Details", 'Company Details', 'Photo'];
