...
const Clientship: React.FC = () => {
    ...
    const backendColumns = ['Profile', 'RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'RegistrationNumber', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Photo'];
