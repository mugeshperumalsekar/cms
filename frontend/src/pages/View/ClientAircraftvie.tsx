...
const ClientAircraftview: React.FC = () => {
    ...
    const backendColumns = ['Profile', 'RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'RegistrationNumber', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Organization Details', 'Photo'];
