...
function Identify() {
    ...
    const fetchorganization = async () => {
        try {
            ...
            setOrganization(Array.isArray(organizationResults) ? organizationResults : []);
        } catch (error) {
            console.error('Error fetching Aircraft:', error);
        }
    };
                                ...
                                (selectedcategoryName && name) ? (
                                    ...
                                    {searchPerformed && !loading && (
                                        <>
                                            ...
                                            {selectedRecordType === '5' && organization.length > 0 && (
                                                <Table>
                                                    <TableHead>
                                                        <TableRow>
                                                            <TableCell>UserName</TableCell>
                                            ...
                                            {/* Check if no data available */}
                                            {Entity.length === 0 && Individual.length === 0 && Ship.length === 0 && Aircraft.length === 0 && organization.length === 0 && (
                                                <p style={{ textAlign: 'center' }}>No data available.</p>
                                            )}
                                        </>
                                    )}
