...
import { bank, State, createDetailsRequest, Regulator, RegulatorListData, Gender, RecordTypeData, Dead, InorgPayload, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, Country, CreateCaseDetailsRequest, createBankDetailsRequests, createCompanyDetailsRequests, createCompanyAliasesRequests, createIndPositionsRequests, createIndCaseDetailsRequests, ContactDetailsData, RelativeConfigData, CompanyPayload, CreateorganizationDetailsRequest } from '../../data/services/Search/search-payload';
...
const Individualview: React.FC = () => {
    ...
    // const handleImageClick = (filename: any) => {
    ...
    const backendColumns = ['Profile', 'Record Type', 'Source Link', 'Regulator', 'Regulator List', 'Name', 'Aliases Name', 'Gender', 'Date of Birth', 'Birth Year Alone', 'Place of Birth', 'Dead', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Organization Details', 'Position Details', 'Unique Number', "Bank Details", 'Company Details'];
