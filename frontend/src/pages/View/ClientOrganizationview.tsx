...
const Client: React.FC = () => {
    ...
    const backendColumns = ['Profile', 'RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Organization Details', 'Case Detail', 'Bank Details', 'Photo'];
