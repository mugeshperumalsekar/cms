...
import { bank, createDetailsRequest, Regulator, RegulatorListData, RecordTypeData, Dead, InorgPayload, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, Country, CreateCaseDetailsRequest, createBankDetailsRequests, createCompanyDetailsRequests, createIndPositionsRequests, createIndCaseDetailsRequests, RelativeConfigData, ContactDetailsData, CreateorganizationDetailsRequest } from '../../data/services/Search/search-payload';
...
const ManagerEntityview: React.FC = () => {
    ...
    const backendColumns = ['Profile', 'RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Organization Details', 'Unique Number', "Bank Details"];
                            ...
                            >
                                <Box m={4}>
                                    <Grid container justifyContent="space-between" alignItems="center">
                                        <Grid item>
                                            <h4 style={{ marginBottom: '1%' }}>MANAGER Organization  VIEW</h4>
                                        </Grid>
                                    </Grid>
