...
const ManagerIndividualview: React.FC = () => {
    ...
    const backendColumns = ['Profile', 'RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'Gender', 'Date of Birth', 'BirthYearAlone', 'Place of Birth', 'Dead', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Organization Details', 'Positions Detail', 'Unique Number', "Bank Details", 'Company Details'];
