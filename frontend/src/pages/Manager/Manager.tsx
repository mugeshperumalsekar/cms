...
//         const searchLower = inputValue.toLocaleLowerCase();
//         const filteredData: CustomerPayload[] = all.filter(item =>
...
//         if (newTab) {
//             const tabData = { uid, cmsId, recordTypeId, route };
//             sessionStorage.setItem(`tabData-${uid}`, JSON.stringify(tabData));
//         }
//     };
